...
export class PlayeronepositionComponent {
  ...
  positionShip (cellValue: string) {
    if (this.typeOfBattleShip === 'Carrier') {
      for (var carrierPositionCounter = 0; carrierPositionCounter < 1; carrierPositionCounter++) {
        if (this.playerOneCarrierPosition.length < 5 && this.gridTogglar < 17 && !this.playerOneCarrierPosition.includes(cellValue) && !this.playerOneShipPositions.includes(cellValue)) {
          this.onClickIncrement ();
          this.playerOneCarrierPosition.push(cellValue);
          this.playerOneShipPositions.push(cellValue);
    ...
    if (this.typeOfBattleShip === 'Frigate') {
      for (var frigatePositionCounter = 0; frigatePositionCounter < 1; frigatePositionCounter++) {
        if (this.playerOneFrigatePosition.length < 4 && this.gridTogglar < 17 && !this.playerOneFrigatePosition.includes(cellValue) && !this.playerOneShipPositions.includes(cellValue)) {
          this.onClickIncrement ();
    ...
    if (this.typeOfBattleShip === 'Cruiser') {
      for (var cruiserPositionCounter = 0; cruiserPositionCounter < 1; cruiserPositionCounter++) {
        if (this.playerOneCruiserPosition.length < 3 && this.gridTogglar < 17 && !this.playerOneCruiserPosition.includes(cellValue) && !this.playerOneShipPositions.includes(cellValue)) {
          this.onClickIncrement ();
    ...
    if (this.typeOfBattleShip === 'Submarine') {
      for (var submarinePositionCounter = 0; submarinePositionCounter < 1; submarinePositionCounter++) {
        if (this.playerOneSubmarinePosition.length < 3 && this.gridTogglar < 17 && !this.playerOneSubmarinePosition.includes(cellValue) && !this.playerOneShipPositions.includes(cellValue)) {
          this.onClickIncrement ();
    ...
    if (this.typeOfBattleShip === 'Destroyer') {
      for (var destroyerPositionCounter = 0; destroyerPositionCounter < 1; destroyerPositionCounter++) {
        if (this.playerOneDestroyerPosition.length < 2 && this.gridTogglar < 17 && !this.playerOneDestroyerPosition.includes(cellValue) && !this.playerOneShipPositions.includes(cellValue)) {
          this.onClickIncrement ();
